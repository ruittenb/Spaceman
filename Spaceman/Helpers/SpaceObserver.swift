...
class SpaceObserver {
    ...
    @objc public func updateSpaceInformation() {
        ...
        workerQueue.async { [weak self] in
            self?.performSpaceInformationUpdate(restartNumberingByDesktop: restartNumberingByDesktop, reverseDisplayOrder: reverseDisplayOrder, verticalDirection: verticalDirection)
        }
    }

    private func performSpaceInformationUpdate(restartNumberingByDesktop: Bool, reverseDisplayOrder: Bool, verticalDirection: VerticalDirection) {
